          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                minLength="6"
                className={`w-full px-4 sm:px-5 py-2 sm:py-3 pr-12 text-base sm:text-lg rounded-lg sm:rounded-xl border focus:outline-none focus:ring-2 ${inputStyles}`}
                placeholder="••••••••"
              />
              <button
                type="button"
                onClick={() => setShowPassword(!showPassword)}
                className={`absolute right-3 top-1/2 -translate-y-1/2 p-1 ${theme === 'dark' ? 'text-neutral-400 hover:text-neutral-200' : 'text-neutral-500 hover:text-neutral-700'} transition-colors`}
